...
const { UsersRoutes, authRoutes, ProductosRoutes, ProductosClientesRoutes, ClientesRoutes, PedidosRoutes, AuditoriaRoutes, ArchivosRoutes, ProductosMesesRoutes, EmailAllowRoutes, SucursalesRoutes } = require("./routes");
...
app.use("/api/v1", SucursalesRoutes);
